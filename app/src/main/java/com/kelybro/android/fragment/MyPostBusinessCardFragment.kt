...
class MyPostBusinessCardFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        recyclerView = view?.findViewById(R.id.bc_recyclerView) as RecyclerView
        recyclerView!!.layoutManager = LinearLayoutManager(context, LinearLayout.VERTICAL, false) as RecyclerView.LayoutManager?
        adapter = BusinessCardAdapter(MyBussinessCardList, MyImageBusinessCard, context)
...
/*
    private fun MakeVolleyRequestOld() {
