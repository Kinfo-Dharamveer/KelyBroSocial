...
import com.kelybro.android.adapters.FollowingAdapter
...
class FollowingFragment : Fragment() {
    ...
    internal val FollowingDataList:MutableList<MutableList<String>>?= ArrayList()
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        recyclerView = view.findViewById<RecyclerView>(R.id.recyclerView_following) as RecyclerView
        recyclerView!!.layoutManager = LinearLayoutManager(this.activity!!, LinearLayout.VERTICAL, false) as RecyclerView.LayoutManager?
        adapter = FollowingAdapter(FollowingDataList, context)
    ...
    private fun MakeVolleyRequest() {
        ...
        if(mSPF.getString("ProfileID","").equals(mSPF.getString("id","")))
            mURL = getString(R.string.server_url)+"Users/my_following_list"
        else
            mURL = getString(R.string.server_url)+"Users/user_following_list"
